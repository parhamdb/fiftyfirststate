...
1. **Military takeover**: Mid-level IRGC leaders impose military rule
2. **Regime reconsolidation**: System selects a new Supreme Leader
3. **Fragmentation**: If security forces split, rapid collapse (Libya/Iraq scenario)
4. **Negotiated transition**: Unlikely without external pressure
